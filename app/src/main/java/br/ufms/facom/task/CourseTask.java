...
public class CourseTask extends AsyncTask<String, Integer, String>
{
    private OkHttpClient client = new OkHttpClient();
    private static final String TAG = CourseTask.class.getCanonicalName();

    private Refreshable ref;

    public CourseTask(Refreshable ref)
    {
        this.ref = ref;
    }
